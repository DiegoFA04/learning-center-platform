...
import com.example.learning.center.platform.learning.domain.model.entities.ProgressRecordItem;
...
public class ProgressRecord {
    ...
    public void startTutorial(Long tutorialId) {
        if (hasAnItemInProgress()) throw new IllegalStateException("Tutorial is already in progress");
