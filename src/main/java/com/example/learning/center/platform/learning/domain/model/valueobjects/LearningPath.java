...
public class LearningPath {
    ...
    public LearningPathItem getLastItemInLearningPath() {
        return learningPathItems.stream().filter(items -> items.getNextItem() == null)
                .findFirst().orElse(null);
    }

    public LearningPathItem getLearningPathWithTutorialId(Long tutorialId) {
    ...
    public void addItem(Course course, Long tutorialId, Long nextTutorialId) {
        LearningPathItem nextItem = this.getLearningPathWithTutorialId(nextTutorialId);
    ...
    public Long getNextTutorialIdInLearningPath(Long currentTutorialId) {
         LearningPathItem item = this.getLearningPathWithTutorialId(currentTutorialId);
         return item != null ? item.getNextItem().getTutorialId() : null;
    }

    public boolean isLastTutorialLearningPath(Long currentTutorialId) {
