package com.example.learning.center.platform.learning.interfaces.rest;

import com.example.learning.center.platform.learning.domain.model.commands.CancelEnrollmentCommand;
import com.example.learning.center.platform.learning.domain.model.commands.ConfirmEnrollmentCommand;
import com.example.learning.center.platform.learning.domain.model.commands.RejectEnrollmentCommand;
import com.example.learning.center.platform.learning.domain.model.queries.GetAllEnrollmentsQuery;
import com.example.learning.center.platform.learning.domain.model.queries.GetEnrollmentByAcmeStudentRecordIdAndCourseIdQuery;
...
import com.example.learning.center.platform.learning.interfaces.rest.transform.EnrollmentResourceFromEntityAssembler;
import com.example.learning.center.platform.learning.interfaces.rest.transform.RequestEnrollmentCommandFromResourceAssembler;
import com.example.learning.center.platform.shared.interfaces.rest.resources.MessageResource;
...
public class EnrollmentsController {
    ...
    public ResponseEntity<EnrollmentResource> requestEnrollment(@RequestBody RequestEnrollmentResource resource) {
        ...
        var getEnrollmentByAcmeStudentRecordIdQuery = new GetEnrollmentByAcmeStudentRecordIdAndCourseIdQuery(
                requestEnrollmentCommand.studentRecordId(), requestEnrollmentCommand.courseId());
        var enrollment = enrollmentQueryService.handle(getEnrollmentByAcmeStudentRecordIdQuery);
